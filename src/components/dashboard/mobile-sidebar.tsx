...
export default function MobileSidebar() {
  ...
  const navItems = [
    ...
    { label: "Engage", href: "/dashboard/engage" },
        ...
        <div className="flex items-center gap-2 ml-4">
          {navItems.map((item) => (
            ...
            >
              ...
              {item.label === "Engage" && (
                <svg className="w-3 h-3 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405M15 17l-1.405-1.405M15 17l-1.405 1.405M15 17l1.405 1.405M3 8v13h18V8l-9-5-9 5z" />
                </svg>
              )}
              {item.label === "Support" && (
                <svg className="w-3 h-3 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
